...
para(58,751,'<b>Still provisional:</b> validate 4 A against measured startup current, wire size and fault current. The Blender fuse is a generic placeholder; lead bends, insulation and mounting need a fit check. Photo: Littelfuse / DigiKey, reference image supplied with this product listing.',1080,11,MUTED)
